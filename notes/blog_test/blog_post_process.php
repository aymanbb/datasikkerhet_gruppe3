...
if(isset($_FILES['uploadimage']))
{
  ...
  move_uploaded_file($tempname, "/var/www/html/blog_test/media/" . $GLOBALS['filename']); //endra fra images til media/ også i html-en
}
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="width: 50%; margin: auto; text-align: justify; font-family: Roboto, sans-serif;">
      ...
      <center><img src="media/<?php echo $filename; ?>" id="showImage" style="width: 50%; height: auto;"></center>
